...
%\begin{center}
	...
	price &  column includes the cost of the laptop \\ 
	discount & column mentions any applicable discounts on the laptop's price\\
	Processor& column specifies the type of processor used in the laptop \\
	RAM & column mentions the amount of RAM the laptop has \\
	OS & column lists the operating system installed on the laptop \\
	SSD & column indicates the size of the solid-state drive\\
	Display & column mentions the screen size and display specifications of the laptop\\
	In build sw & column lists any software pre-installed on the laptop \\
	warranty & column provides information on the warranty offered for the laptop\\
	\hline
	\end{tabular}
%\end{center}
\end{table}
