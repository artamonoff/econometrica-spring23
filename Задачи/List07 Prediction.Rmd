...
Вычислите прогноз для каждого человека (приближённо по результатам таблицы и точно
...
Вычислите прогноз **зарплаты** для каждого человека (приближённо по результатам таблицы и точно
в Python).  **Ответ округлите до `r my.digits`-х десятичных знаков.**
...
Вычислите прогноз **выпуска** для каждой фирмы (приближённо по результатам таблицы и точно
в Python).  **Ответ округлите до `r my.digits`-х десятичных знаков.**
