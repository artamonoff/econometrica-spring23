...
Рассморим панель `Wages` и регрессию **diff(lwage) на ed, exp, exp^2, wks**
...
Рассморим панель `Wages` и регрессию **diff(lwage) на ed, exp, exp^2, wks, south, smsa, married, union, bluecol**
с индивидуальными эффектами
...
Рассморим панель `Guns` и регрессию **diff(sales) на diff(price), diff(pop), diff(pop16), diff(cpi), diff(ndi), diff(pimin)**
с индивидуальными эффектами
...
Рассморим панель `Guns` и регрессию **sales на price, lag(price) pop, lag(pop) pop16, cpi, lag(cpi), ndi, pimin**
с индивидуальными эффектами
...
Рассморим панель `Guns` и регрессию **log(emp) на log(wage), log(capital), log(output)**
с индивидуальными эффектами
...
Рассморим панель `Guns` и регрессию **diff(log(emp)) на diff(log(wage)), diff(log(capital)), diff(log(output))**
с индивидуальными эффектами
...
Рассморим панель `Guns` и регрессию **log(emp) на log(wage), lag(log(wage)), log(capital), lag(log(capital)), log(output), lag(log(output))**
с индивидуальными эффектами
