...
Для датасета [mroz_Green](http://meit.mgimo.ru/sites/default/files/mroz_Greene.csv)
...
new.df.to.predict <- data.frame(new.df$WA, log(new.df$FAMINC), new.df$WE,
...
round( data.frame( Прогноз.LPM=my.predict.LPM, Прогноз.logit=my.predict.logit, Прогноз.probit=my.predict.probit ),
                 digits = my.digits )
# stargazer( data.frame( Прогноз.LPM=my.predict.LPM, Прогноз.logit=my.predict.logit, Прогноз.probit=my.predict.probit ),
#            type='text', summary=FALSE,  digits=my.digits )
```
...
coefs.logit <- round(coef(regr.logit), digits = my.digits.output)
coefs.probit <- round(coef(regr.probit), digits = my.digits.output)
new.df.to.predict <- data.frame(new.df$appinc/100, new.df$mortno, new.df$unem,
...
rm(x)
round( data.frame( Прогноз.LPM=my.predict.LPM, Прогноз.logit=my.predict.logit, Прогнозю.probit=my.predict.probit ),
                 digits = my.digits )
# stargazer(round( data.frame( Прогноз.LPM=my.predict.LPM, Прогноз.logit=my.predict.logit, Прогнозю.probit=my.predict.probit ),
#                  digits = my.digits ), 
...
coefs.logit <- round(coef(regr.logit), digits = my.digits.output)
coefs.probit <- round(coef(regr.probit), digits = my.digits.output)
new.df.to.predict <- data.frame(new.df$income, new.df$income^2, new.df$age, new.df$age^2,
...
round( data.frame( Прогноз.LPM=my.predict.LPM, Прогноз.logit=my.predict.logit, Прогнозю.probit=my.predict.probit ),
                 digits = my.digits )
# stargazer( data.frame( Прогноз.LPM=my.predict.LPM, Прогноз.logit=my.predict.logit, Прогнозю.probit=my.predict.probit ), 
#           type='text', summary=FALSE, digit.separator = '', digits=my.digits)
```